...
Debian packaging for Go 1.22: repackages the official precompiled toolchain from [go.dev](https://go.dev/dl/) into `golang-1.22-go` packages for enterprise `.deb`-only installs.
